...
export default function Form() {
  ...
  const visitChange = (event: SelectChangeEvent) => {
    setVisit(event.target.value as string);
  };

  const [clima, setClima] = React.useState("");

  const climaChange = (event: SelectChangeEvent) => {
    setClima(event.target.value as string);
  };

  const [tec, setTec] = React.useState("");

  const tecChange = (event: SelectChangeEvent) => {
    setTec(event.target.value as string);
  };

  const [tanqueEqu, setTanqueEqu] = React.useState("");

  const tanqueEquChange = (event: SelectChangeEvent) => {
    setTanqueEqu(event.target.value as string);
  };
          ...
          >
            ...
            >
              ...
              <Select
                ...
                onChange={climaChange}
              >
                <MenuItem value={"Ensolarado"}>Ensolarado</MenuItem>
                <MenuItem value={"Nublado"}>NUblado</MenuItem>
                <MenuItem value={"Chuvoso"}>Chuvoso</MenuItem>
              </Select>
              <Typography component="h1" variant="h5">
                Técnico responsável
              </Typography>
              ...
              <Select fullWidth value={tanqueEqu} onChange={tanqueEquChange}>
                {percentage.map((data) => (
              ...
              />
              <Typography component="h1" variant="h5">
                Gerenciamento de Resíduos - Limpeza da área externa em
                conformidade?
              </Typography>
              <TextField
                margin="normal"
              ...
              />
              <Typography component="h1" variant="h5">
                Gerenciamento de Resíduos - Contêineres de Coleta Seletiva em
                conformidade?
              </Typography>
              <TextField
                margin="normal"
              ...
              />
              <Typography component="h1" variant="h5">
                Gerenciamento de Resíduos - Central de armazenamento em
                conformidade?
              </Typography>
              <TextField
                margin="normal"
